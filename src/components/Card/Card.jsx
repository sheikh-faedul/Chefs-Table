 ...
 const card = ({card}) => {
    const{recipe_img,recipe_name,description,ingredients,time,calories}=card
    return (
        <div className='p-3'>
           ...
           <div className='flex justify-between'>
            ...
            <button className='bg-green-400 m-2 p-3 text-xl text-black rounded-2xl'>Want to cook</button> 
